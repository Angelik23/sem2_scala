...
object FunSets {
  ...
  //explanation : http://stackoverflow.com/questions/13052735/is-my-understanding-of-below-scala-code-correct    }
  ...
  def forall(s: Set, p: Int => Boolean): Boolean = {
    def iter(a: Int): Boolean = {
      if (a > bound) false
        // est ce que a est contenu dans s + est qu'il satisfait p
